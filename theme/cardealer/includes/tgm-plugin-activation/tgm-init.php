	...
	function cardealer_tgmpa_plugin_list() {
		...
		$required_plugins = array(
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'cardealer-helper-library-5.3.0.zip' ),
				'required'           => true,
			...
			array(
				...
				'slug'               => 'revslider',
				'source'             => cardealer_tgmpa_plugin_path( 'revslider-6.6.15.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
			...
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'advanced-custom-fields-pro-6.1.8.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
		...
		if ( ! $is_setup_wizard || ( $is_setup_wizard && array_key_exists( $page_builder, $page_builders ) && 'wpbakery' === $page_builder ) ) {
			$plugins[] = array(
				...
				'slug'               => 'js_composer',
				'source'             => cardealer_tgmpa_plugin_path( 'js_composer-7.0.0.zip' ),
		...
		$recommended_plugins = array(
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'cardealer-front-submission-3.10.0.zip' ),
			...
			array(
				...
				'slug'               => 'envato-market',
				'source'             => cardealer_tgmpa_plugin_path( 'envato-market-2.0.10.zip' ),
				'required'           => false,
				'force_activation'   => false,
				'force_deactivation' => false,
				'version'            => '2.0.10',
